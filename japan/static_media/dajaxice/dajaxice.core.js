...
var Dajaxice = {
    ...
    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('japanstudy.sayhello', 'POST', callback_function, argv, custom_settings);
    },

    add_new_words: function(callback_function, argv, custom_settings){
        return Dajaxice.call('japanstudy.add_new_words', 'POST', callback_function, argv, custom_settings);
    }
